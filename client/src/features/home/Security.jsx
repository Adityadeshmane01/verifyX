      ...
      <div className="grid items-center gap-12 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 md:grid-cols-3">
            {COMPLIANCE_ITEMS.map(c => <div key={c.label} className="flex items-center gap-3 rounded-xl border bg-card/40 px-4 py-3 transition-colors hover:border-primary/30">
