...
export function DashboardPreview() {
  return <SectionWrapper id="developers">
        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-[1.4fr_1fr]">
          <div className="rounded-2xl border bg-card p-6">
            ...
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={TREND_DATA} margin={{
                top: 6,
                right: 6,
                left: -20,
                bottom: 0
          ...
          <div className="rounded-2xl border bg-card p-6">
            ...
            <ul className="space-y-3">
              {RECENT_VERIFICATIONS.slice(0, 5).map(r => <li key={r.id} className="flex items-center justify-between gap-3 border-b border-border/50 pb-3 last:border-0 last:pb-0">
